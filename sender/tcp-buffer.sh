...
for i in 100 200 400 800 1600 3200 6400 12800; do
    ./run_experiment_sender.py --receiver $public_dst_ip --addr $device_dst_ip --window $i --throughput --utilisation --cache-miss --latency --arfs --output results/tcp-buffer_all-opts_${i} | tee results/tcp-buffer_all-opts_${i}.log
done
