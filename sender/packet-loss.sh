...
for i in 100 1000 10000; do
    ./run_experiment_sender.py --receiver $public_dst_ip --addr $device_dst_ip --throughput --utilisation --output results/packet-loss_no-opts_${i} | results/packet-loss_no-opts_${i}.log
done

# TSO/GRO
./network_setup.py $iface --gro --tso
for i in 100 1000 10000; do
    ./run_experiment_sender.py --receiver $public_dst_ip --addr $device_dst_ip --throughput --utilisation --output results/packet-loss_tsogro_${i} | results/packet-loss_tsogro_${i}.log
done

# TSO/GRO+Jumbo Frame
./network_setup.py $iface --mtu 9000
for i in 100 1000 10000; do
    ./run_experiment_sender.py --receiver $public_dst_ip --addr $device_dst_ip --throughput --utilisation --output results/packet-loss_tsogro+jumbo_${i} | results/packet-loss_tsogro+jumbo_${i}.log
done
