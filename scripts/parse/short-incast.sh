...
echo -e "config\trpc size\t$(awk -F'\t' '/summary/{getline; print $4}' $results_dir/short-incast_16_4000_no-opts.log)" > $tmp
...
echo -e "n\t$(awk '/receiver utilisation breakdown/{getline; print}' $results_dir/short-incast_16_4000_all-opts.log)" > $tmp
for n in 4000 16000 32000 64000; do
