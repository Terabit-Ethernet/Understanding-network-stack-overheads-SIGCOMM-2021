...
echo -e "config\tn\t$(awk -F'\t' '/summary/{getline; print $4}' $results_dir/packet-loss_no-opts_1000.log)" > $tmp
...
echo -e "n\t$(awk '/receiver utilisation breakdown/{getline; print}' $results_dir/packet-loss_all-opts_1000.log)" > $tmp
for n in 100 1000 10000; do
